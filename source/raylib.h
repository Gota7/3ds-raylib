...
// 3ds.
RLAPI void SetCurrentScreen(int screen);
RLAPI int GetCurrentScreen(void);
RLAPI int GetBottomScreenWidth(void);
RLAPI int GetBottomScreenHeight(void);
RLAPI void BeginDrawingBottom(void);
