...
// Returns orthographic projection matrix, tilted for the 3ds screen.
RMDEF Matrix MatrixOrthoTilt(double left, double right, double bottom, double top, double near, double far)
{
    Matrix result = { 0 };
    ...
    result.m1 = 2.0f / tb;
    result.m2 = 0.0f;
    result.m3 = (bottom + top) / (bottom - top);
    result.m4 = 2.0f / (left - right);
    result.m5 = 0.0f;
    result.m6 = 0.0f;
    result.m7 = (left + right) / rl;
    result.m8 = 0.0f;
    result.m9 = 0.0f;
    result.m10 = 1.0f / fn;
    result.m11 = 0.5f*(near + far) / (near - far) - 0.5f;
    result.m12 = 0.0f;
    result.m13 = 0.0f;
    result.m14 = 0.0f;
    result.m15 = 1.0f;
